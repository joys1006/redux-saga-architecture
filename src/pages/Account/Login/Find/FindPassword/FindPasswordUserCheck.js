...
export class FindPasswordUserCheck extends Component {
    ...
    handleSubmit = (e) => {
        ...
        if (check) {
            ...
            history.push('/find-password/reset');
        } else {
...
FindPasswordUserCheck = PagePanel()(FindPasswordUserCheck);
FindPasswordUserCheck = Form.create()(FindPasswordUserCheck);
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(withRouter(FindPasswordUserCheck));
